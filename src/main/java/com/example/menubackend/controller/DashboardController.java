...
public class DashboardController {
    ...
    public ResponseEntity<Map<String, Object>> getEstatisticas() {
        ...
        estatisticas.put("pedidosEmProducao", pedidoService.countByStatus(Pedido.StatusPedido.EM_PRODUCAO));
        estatisticas.put("pedidosProntos", pedidoService.countByStatus(Pedido.StatusPedido.PRONTO));
        estatisticas.put("pedidosFinalizados", pedidoService.countByStatus(Pedido.StatusPedido.FINALIZADO));
    ...
    public ResponseEntity<Map<String, Object>> getResumoPedidos() {
        ...
        resumo.put("pedidosEmProducao", pedidoService.countByStatus(Pedido.StatusPedido.EM_PRODUCAO));
